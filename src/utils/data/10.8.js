module.exports = {
	...
	items     : {
		...
		bow_bow         : {
			...
			perk_full : `Wearer gains +200% Attack Range.`,
			perk_100  : `Wearer gains +200% Attack Range`,
			perk      : `Triples attack range`,
		},
		bow_cloak       : {
			id        : 'runaanshurricane',
		...
		cloak_tear      : {
			...
			perk_full : `Whenever you cast your spell, you and all nearby allies gain 10 mana`,
			perk_100  : `Whenever you cast your spell, you and all nearby allies gain 10 mana`,
			perk      : 'When you cast spell, +10 mana for yourself & all nearby allies',
		},
		cloak_vest      : {
			id        : 'swordbreaker',
			name      : `Swordbreaker`,
		...
		sword_sword     : {
			...
			perk_100  : `On Kill/Assist, +30 Attack Damage for rest of combat (infinite stack)`,
			perk      : 'On kill/assist, +30 atk (stacks infinitely)',
		},
		sword_tear      : {
			id        : 'spearofshojin',
